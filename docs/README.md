...
|----------|-------------|
| [Getting Started](./GETTING-STARTED.md) | Quick setup guide for developers |
| [Connecting to pNode](./CONNECTING-PNODE.md) | How to connect XanScope to a real pNode |
...
|-------------|--------|-------|
| Web-based analytics platform | ✅ | Next.js 15 + React 19 |
| Retrieve pNodes via pRPC | ✅ | `get-pods`, `get-stats`, `get-version` |
| Display pNode information | ✅ | Grid view, table view, detail pages |
| Accessible and usable | ✅ | Responsive, dark theme, intuitive UX |
| Deployment documentation | ✅ | See `/docs` folder |
...
- [pNode Operator Guide](https://docs.xandeum.network/operator-guides)
